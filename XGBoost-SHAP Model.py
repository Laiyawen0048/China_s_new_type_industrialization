...
plt.rcParams['axes.unicode_minus'] = False  # Fix issue with negative sign display
...
feature_name = "R&D Funding"  # Make sure this feature name is in your dataset
shap.dependence_plot(feature_name, shap_values.values, X_test)  # Use .values to get SHAP values array
feature_name = "CPPTY"  # Make sure this feature name is in your dataset
shap.dependence_plot(feature_name, shap_values.values, X_test)  # Use .values to get SHAP values array
feature_name = "BAPN"  # Make sure this feature name is in your dataset
shap.dependence_plot(feature_name, shap_values.values, X_test)  # Use .values to get SHAP values array
feature_name = "EPUIVA"  # Make sure this feature name is in your dataset
shap.dependence_plot(feature_name, shap_values.values, X_test)  # Use .values to get SHAP values array
